...
if __name__=='__main__':
    df = pd.read_csv('data/df_for_model.csv', index_col=0)
    df = pd.concat([
    ...
    train_model_full_pipeline(X, y, GradientBoostingClassifier(random_state=42), params_for_gradient_boosting, 0.2, save_path='model.pkl')